...
export default function VisionMissionSection() {
  return (
    <section className="bg-surface-soft pt-0 pb-12 sm:pb-14 lg:pb-16">
      <div className="relative mx-3 w-auto rounded-t-2xl bg-primary px-6 py-14 sm:px-10 lg:pl-28 lg:pr-20 lg:py-16 xl:pl-32 xl:pr-24">
        ...
        <SlideIn
          direction="right"
          className="border-x border-b border-primary/35 bg-surface-soft p-10 sm:px-8 lg:absolute lg:top-0 lg:right-50 lg:mt-0 lg:w-[30%] lg:rounded-b-2xl"
        >
          <article>
